...
(defparameter *ml-progs-directory* "/home/andreea/Desktop/PFOIL/")
...
(defun binary-feature-p (feature)
  (member (feature-domain feature) '((true false)(false true)(f t)(t f)(no yes)(yes no))
	  :test #'equal))
